...
#define get_ms Delay_Getxms
#define i2c_write IIC_WriteReg
#define i2c_read IIC_ReadReg
#define fabs fabsf
#define min(a, b) ((a < b) ? a : b)
#define log_i(...) \
    do             \
...
#if !defined MPU6050 && !defined MPU9150 && !defined MPU6500 && !defined MPU9250 && !defined MPU6050
